        ...
        <div className="p-5 border-b border-slate-200/60 dark:border-slate-700/60">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2.5">
              <div className="p-2 rounded-xl bg-linear-to-br from-indigo-500 to-purple-600 text-white shadow-lg">
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg text-xs font-medium transition-all duration-200 ${
                categoryFilter === cat
                  ...
                  : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/50 hover:text-indigo-600'
              }`}
          ...
          {filteredTopics.length === 0 ? (
            ...
            filteredTopics.map((topic) => {
              ...
              return (
                ...
                >
                  <Icon
                    className={`w-4 h-4 shrink-0 ${isActive ? 'text-white' : 'text-indigo-500 dark:text-indigo-400'}`}
                    aria-hidden="true"
                  />
